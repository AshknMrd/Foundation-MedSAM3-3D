...
class SAM3LoRAInference:
    def __init__(self, config_path, sam3_checkpoint, weights_path):
        """
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to sam3 checkpoint in the local folder"
    )
    parser.add_argument(
        "--weights",
        type=str,
    ...
    inferencer = SAM3LoRAInference(args.config, args.sam3_chk, args.weights)
